...
public:
	...
	enum ChatType {
		...
		CHAT_ACHIEVEMENT = 0x30,
		CHAT_BG_SYSTEM_NEUTRAL = 0x52,
		CHAT_BG_SYSTEM_ALLIANCE = 0x53,
		CHAT_BG_SYSTEM_HORDE = 0x54,
		CHAT_GUILD_ACHIEVEMENT = 0x31,
		CHAT_RAID_LEADER = 0x57,
		CHAT_RAID_WARNING = 0x58,
		CHAT_RAID_BOSS_WHISPER = 0x59,
		CHAT_RAID_BOSS_EMOTE = 0x5A,
		CHAT_BATTLEGROUND = 0x5C,
		CHAT_BATTLEGROUND_LEADER = 0x5D,
	};
