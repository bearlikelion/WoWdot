...
struct M2Material {
    ...
    uint16_t blendMode;   // 0=Opaque, 1=AlphaKey, 2=Alpha, 3=NoAlphaAdd, 4=Add, 5=Mod, 6=Mod2x, 7=BlendAdd
};
...
struct M2Attachment {
    ...
    glm::quat rotation{1.0f, 0.0f, 0.0f, 0.0f}; // WOM-only grip orientation, identity for M2
};
