...
public:
    ...
    void setNeutral(bool n) { neutral = n; }
    // Hostile or neutral units can be attacked and tab targeted; only friendly ones cannot.
    bool isAttackable() const { return hostile || neutral; }
